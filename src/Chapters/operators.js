    ...
    return (
      <div>
        <div className="centerParagraph-ofHome">
          <div>
            <p>
              The main operators discuss in the dart programming language are as
              follows: -{" "}
            </p>
            <ul>
            ...
            <p>
              An expression is a special kind of statement that evaluates to a
              value. Every expression is composed of −
            </p>
            <ul>
              <li>Operands − Represents the data</li>
              <li>
                Operator − Defines how the operands will be processed to produce
                a value
              </li>
            </ul>
            <p>
              Consider the following expression – "2 + 3". In this expression, 2
              and 3 are operands and the symbol "+" (plus) is the operator.
            </p>
          </div>
          <hr />
            ...
            <table className="table-operator">
              ...
              <tr>
                ...
                <td>
                  ...
                  operand <br /> <b>Ex:</b>C = A + B will assign the value of A
                  + B into C{" "}
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>+=</td>
                <td>
                  (Add and Assignment) <br />
                  It adds the right operand to the left operand and assigns the
                  result to the left operand. <br /> <b>Ex:</b>C += A is
                  equivalent to C = C + A
                </td>
              </tr>
              <tr>
          ...
          <div>
            ...
            <table className="table-operator">
              ...
              <tr>
                ...
                <td>&amp;&amp;</td>
                <td>
                  <b>And</b> − The operator returns true only if all the
              ...
              <tr>
                ...
                <td>||</td>
                <td>
                  <b>OR</b> − The operator returns true if at least one of the
                  expressions specified return true
                </td>
              ...
              <tr>
                ...
                <td>!=</td>
                <td>
                  <b>NOT</b> − The operator returns the inverse of the
                  expression’s result. <br />
                  For E.g.: !(7&gt;5) returns false
                </td>
                <td>!(A &gt; 10) is True.</td>
              </tr>
            </table>
          ...
          <div>
            ...
            <table className="table-operator">
              ...
              <tr>
                ...
                <td>a &lt;&lt; b</td>
                <td>
                  Shifts a in binary representation b (&lt; 32) bits to the
                  left, shifting in zeroes from the right.
                </td>
              </tr>
              <tr>
                <td>6</td>
          ...
          <div className="source">
            <a
              ...
              href="https://www.tutorialspoint.com/dart_programming/dart_programming_operators.htm"
              target="_blank"
          ...
          <div className="mock-test">
            ...
            <div className="test-container">
              <h1 id="correct-operator" className="correct">
                Correct!!
              </h1>
            </div>
          </div>

        ...
        <div className="centerParagraph-ofHome">
          <div>
            ...
            <p>
              ...
              code inside the if statement will be executed. If Boolean
          ...
          <div>
            ...
            <p>
              The if block guards the conditional expression. The block
              associated with the if statement is executed if the Boolean
              expression evaluates to true. The if block may be followed by an
              optional else statement. The instruction block associated with the
              else block is executed if the expression evaluates to false.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="source-code1">
              ...
              &emsp;&#125; else &#123; <br />
              &emsp;&emsp;print("&dollar;&#123;num&#125; is neither positive nor
              negative"); <br />
              &emsp;&#125; <br />
              &#125;
            </p>
            <p>
              When using if…else statements, there are a few points to keep in
              mind. An if can have zero or one else's and it must come after any
              else…if's. An if can have zero to many else…if's and they must
              come before the else. Once an else…if succeeds, none of the
          ...
          <div>
            ...
            <p>
              The example verifies the value of the variable grade against the
              set of constants (A, B, C, D, and E) and executes the
              corresponding blocks. If the value in the variable doesn’t match
              any of the constants mentioned above, the default block will be
              executed.
            </p>
          </div>
          <br />
          ...
          <div className="source">
            <a
              ...
              href="https://www.tutorialspoint.com/dart_programming/dart_programming_decision_making.htm"
              target="_blank"
          ...
          <div className="mock-test">
            ...
            <div className="test-container">
              <h1 id="correct-decision" className="correct">
                Correct!!
              </h1>
            </div>
          </div>

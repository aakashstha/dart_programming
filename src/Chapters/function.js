        ...
        return <div>
            ...
            <div className="centerParagraph-ofHome">  
                ...
                <div>
                    ...
                    <p>A function definition specifies what and how a specific task would be done. Before using a function, it must be defined.</p>
                ...
                <div>
                    ...
                    <p>A function must be called to execute it. This process is termed as function invocation.</p>
                ...
                <div>
                    ...
                    <p>Functions may also return value along with the control, back to the caller. Such functions are called as returning functions.</p>

                    <ul>
                        <li>The return_type can be any valid data type</li>
                        <li>The return statement is optional. I not specified the function returns null;</li>
                        <li>The data type of the value returned must match the return type of the function.</li>
                        <li>A function can return at the most one value. In other words, there can be only one return statement per function.</li>
                ...
                <div className="source">
                    <a className="main-source" href="https://www.tutorialspoint.com/dart_programming/dart_programming_functions.htm" target="_blank" rel="noopener noreferrer">source</a>
                </div>
                ...
                <hr className="horizontal-line" />
                    ...
                    <div className="test-container">
                        <span><input id="input-function" /><input id="input-function1" /></span>
                        <span>()&nbsp;&#123;</span>
                    ...
                    <div className="test-container">
                        <button className="inner-button" type="button" onClick={this.changeFunction}>Done</button>
                    </div>

                    <div className="test-container ">
                        <h1 id="correct-function" className="correct">Correct!!</h1>
                    </div>

    ...
    return (
      <div>
        <div className="centerParagraph-ofHome">
          <p>
            A variable is “a named space in the memory” that stores values. In
            other words, it acts a container for values in a program. Variable
            names are called identifiers. Following are the naming rules for an
            identifier −
          </p>
          ...
          <ul>
            ...
            <li>
              Identifiers cannot contain spaces and special characters, except
          ...
          <p>
            If you never intend to change a variable, use <b>final</b> or{" "}
            <b>const</b>, either instead of var or in addition to a type. A
            final variable can be set only once; a const variable is a
            compile-time constant. (Const variables are implicitly final.) A
            final top-level or class variable is initialized the first time it’s
            used.
          </p>
          ...
          <p>
            ...
            reference to a String object with a value of “Aaron”.The type of the
            name variable is inferred to be String, but you can change that type
            by specifying it
          </p>
          <p>dynamic name = 'Aaron';</p>

          <p>
            Another option is to explicitly declare the type that would be
            inferred
          </p>
          ...
          <p>
            The main difference between final and const is final mostly used
            inside a class to make a constant value whereas const can be used
            anywhere in the programme but if you want to use const in classes
            like final then you have to make static const in class.
          </p>
          <br />
          ...
          <div className="source">
            <a
              ...
              href="https://www.tutorialspoint.com/dart_programming/dart_programming_variables.htm"
              target="_blank"
          ...
          <div className="mock-test">
            ...
            <div className="test-container">
              <h1 id="correct-var" className="correct">
                Correct!!
              </h1>
            </div>
          </div>

        ...
        <div className="centerParagraph-ofHome">
          <div>
            ...
            <p>
              ...
              inheritance. Every object is an instance of a class, and all
              classes descend from Object. Mixin-based inheritance means that
              although every class (except for Object) has exactly one
              superclass, a class body can be reused in multiple class
              hierarchies. Extension methods are a way to add functionality to a
              class without changing the class or creating a subclass.
            </p>

            <h3>Declaring a class</h3>
            <p>
              Use the <b>class</b> keyword to declare a class in Dart. A class
              definition starts with the keyword class followed by the class
              name; and the class body enclosed by a pair of curly braces. The
          ...
          <div>
            ...
            <ul>
              <li>
                Fields - A field is any variable declared in a class. Fields
                represent data pertaining to objects.
              </li>
              <li>
                Setters and Getters − Allows the program to initialize and
                retrieve the values of the fields of a class. A default getter/
                setter is associated with every class. However, the default ones
                can be overridden by explicitly defining a setter/ getter.
              </li>
              <li>
                Constructors − responsible for allocating memory for the objects
                of the class.
              </li>
              <li>
          ...
          <div>
            ...
            <p>
              The example declares a class Car. The class has a field named
              engine. The disp() is a simple function that prints the value of
              the field engine.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              defines a constructor with the same name as that of the class. A
          ...
          <div>
            ...
            <p>
              Dart provides named constructors to enable a class define multiple
              constructors.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Getters and Setters, also called as accessors and mutators, allow
              the program to initialize and retrieve the values of class fields
              respectively. Getters or accessors are defined using the get
              keyword. Setters or mutators are defined using the set keyword.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="source-code1">
              ...
              &emsp;&emsp;print("calling calc area defined in the Shape class");{" "}
              <br />
              &emsp;&#125; <br />
              &#125; <br />
            ...
            <p>
              ...
              program to create new classes from an existing class. The class
              that is extended to create newer classes is called the parent
              class/super class. The newly created classes are called the
              child/sub classes.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="source-code1">
              ...
              &#125; <br />
              class Parent &#123; <br />
              &emsp;void m1(int a)&#123; print("value of a
              &dollar;&#123;a&#125;"); <br />
              &#125; <br />
            ...
            <p>
              ...
              redefines a method in its parent class.The number and type of the
              function parameters must match while overriding the method. In
              case of a mismatch in the number of parameters or their data type,
          ...
          <div>
            ...
            <p className="source-code1">
              ...
              &emsp;static disp() &#123; <br />
              &emsp;&emsp;print("The value of num is
              &dollar;&#123;StaticMem.num&#125;"); <br />
              &emsp;&#125; <br />
              &#125; <br />
              void main() &#123; <br />
            ...
            <p>
              ...
              i.e., fields and methods. A static variable retains its values
              till the program finishes execution. Static members are referenced
              by the class name.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="source-code1">
              ...
              &#125; <br />
              class Parent &#123; <br />
              &emsp;String msg = "message variable from the parent class";{" "}
              <br />
              &emsp;void m1(int a)&#123; print("value of a
              &dollar;&#123;a&#125;");&&emsp;#125; <br />
              &#125; <br />
              class Child extends Parent &#123; <br />
              &emsp;@override <br />
              &emsp;void m1(int b) &#123; <br />
            ...
            <p>
              ...
              class. The keyword can be used to refer to the super class version
          ...
          <div className="source">
            <a
              ...
              href="https://www.tutorialspoint.com/dart_programming/dart_programming_classes.htm"
              target="_blank"
          ...
          <div className="mock-test">
            ...
            <div className="test-container ">
              <h1 id="correct-class" className="correct">
                Correct!!
              </h1>
            </div>
          </div>
